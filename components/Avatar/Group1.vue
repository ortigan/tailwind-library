...
<div class="flex flex-wrap w-full sm:w-fit space-x-2 md:space-x-4 items-center">
  ...
  <div class="flex -space-x-3 items-center">
           <!-- 1 -->
      <div class="flex">
    <div class="w-11 h-11 hover:mr-2 rounded-full border-2 border-white">
      <img
    ...
    <div class="w-11 h-11 hover:mr-2 rounded-full border-2 border-white">
     ...
     <div
      class="
        ...
        justify-center
        rounded-full
        bg-yellow-200 hover:mr-2 border-2 border-white

      "
    >
      <img
        class="w-10 h-10 pt-1 hover:w-10 hover:h-10 object-cover rounded-full"
        src="https://avatars.dicebear.com/api/avataaars/aolraicppre2.svg"
        alt=""
      />
    ...
    >
      ...
      class="
        ...
        justify-center
        rounded-full
        bg-gray-50 ml-2 border border-dashed border-gray-400

      "
    >
      <div class="text-base font-normal text-gray-400">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w- hover:cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
