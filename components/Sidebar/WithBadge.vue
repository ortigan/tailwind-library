<template>
  <div class="md:-ml-20 md:-my-10 w-full text-black">
    <div class="w-64 rounded-2xl bg-white dark:bg-zinc-900 overflow-y-hidden shadow-md">
      <aside class="w-full ">
        <!-- logo -->
        ...
        <!-- logo end -->
        <div
          class="flex flex-col space-y-3 h-96 text-base font-medium text-gray-500 dark:text-zinc-400 mt-8 px-8"
        >
        <div class="flex items-center justify-between hover:font-semibold hover:pl-0.5 transition-all">
          ...
          <div class="flex items-center justify-between gap-2 hover:font-semibold hover:pl-0.5 transition-all">
            ...
            <div class="bg-gray-100 dark:bg-zinc-700 dark:text-zinc-400 text-gray-700 rounded-md py-0.5 px-2 text-xs">
                21
            </div>
          </div>
          <div class="flex items-center gap-2 hover:font-semibold hover:pl-0.5 transition-all">
...
<path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor"  stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div
          class="flex flex-col space-y-2 py-6 text-base font-medium text-gray-500 dark:text-zinc-400 mt-10 pl-8"
        >
          <div class="flex items-center gap-2 hover:font-semibold hover:pl-0.5 transition-all">
            <svg
              width="20"
