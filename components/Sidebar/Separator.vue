...
<path d="M20 15H7H5.23077C3.44646 15 2.5 15.7812 2.5 17C2.5 18.2188 3.44646 19 5.23077 19H19.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
           ...
           <div class="flex items-center justify-between gap-2 hover:cursor-pointer hover:font-semibold hover:pl-0.5 transition-all">
...
<path d="M13.73 21C13.5542 21.3031 13.3019 21.5547 12.9982 21.7295C12.6946 21.9044 12.3504 21.9965 12 21.9965C11.6496 21.9965 11.3054 21.9044 11.0018 21.7295C10.6982 21.5547 10.4458 21.3031 10.27 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="bg-gray-100 text-gray-700 dark:bg-zinc-700 dark:text-zinc-400 rounded-md py-0.5 px-2 text-xs">
                8
            </div>
          </div>
        ...
        <div class="flex flex-col space-y-3  text-base font-medium text-gray-500 dark:text-zinc-400 px-8">
          ...
          <div class="flex items-center gap-2 hover:cursor-pointer hover:font-semibold hover:pl-0.5 transition-all">
           ...
           <div class="flex items-center justify-between gap-2 hover:font-semibold hover:pl-0.5 transition-all">
            ...
            <div class="bg-green-400 text-green-50 rounded-md py-0.5 px-2 text-xs font-semibold">
                new
            </div>
          </div>
          <div class="flex items-center gap-2 hover:cursor-pointer hover:font-semibold hover:pl-0.5 transition-all">
...
<path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
           ...
           <div class="flex items-center gap-2 justify-between hover:cursor-pointer hover:font-semibold hover:pl-0.5 transition-all">
               <div class="flex items-center gap-2">
