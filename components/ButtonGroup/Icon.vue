  ...
  <div class="w-full flex justify-start md:justify-center text-gray-500">
    <div class="">
      <div class="inline-flex -space-x-px font-medium">
        ...
        >
    <svg width="16" height="16" stroke-width="1.5" viewBox="0 0 24 24" fill="currentColor" stroke-xmlns="http://www.w3.org/2000/svg">
...
<path d="M10.0441 5.70436C10.4402 5.41246 11 5.69531 11 6.1874V17.8126C11 18.3047 10.4402 18.5875 10.0441 18.2956L2.15555 12.483C1.8301 12.2432 1.8301 11.7568 2.15555 11.517L10.0441 5.70436Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        >
         <svg width="16" height="16" stroke-width="1.5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
