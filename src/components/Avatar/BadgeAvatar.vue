<template>
  <div class="flex space-x-6">
    ...
    <div
      ...
      "
    >
      <div class="text-base font-medium text-gray-100">P</div>
            <div class="h-3 w-3 bg-green-400 absolute border-2 border-white -right-1 -top-1 rounded-full"></div>
    ...
    <img
        ...
        src="https://res.cloudinary.com/pranav1421/image/upload/v1651752921/Tailwind-Component-library/Human%20avatar/mateus-campos-felipe-JoM_lC1WAnE-unsplash_mxxecb.jpg"
        alt=""
      />
            <div class="text-xxs font-medium px-0.5 bg-red-500 absolute border border-white -right-2 -bottom-2 rounded-full">+99</div>
    ...
    >
      ...
      >
        ...
        />
                  ...
                  <div class="bg-blue-500 absolute border border-white -right-1 -bottom-1 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
    ...
    >
      <img
        ...
        alt=""
      />
        <div class="bg-amber-500 absolute border border-white -right-1 -bottom-1 rounded-full p-0.5"><svg class="text-white" width="12" height="12" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
