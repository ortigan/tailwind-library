<template>
  <pre><code class="language-markup"><script type="prism-html-markup">
    ...
    <aside class="w-full">
      ...
      <div class="mt-8 flex h-96 flex-col space-y-3 px-8 text-base font-medium text-gray-500">
        ...
        <div class="flex items-center justify-between gap-2 transition-all hover:pl-0.5 hover:font-semibold">
          ...
          <div class="rounded-md bg-gray-100 py-0.5 px-2 text-xs text-gray-700">21</div>
        </div>
        <div class="flex items-center gap-2 transition-all hover:pl-0.5 hover:font-semibold">
        ...
        <div class="flex items-center justify-between gap-2 transition-all hover:pl-0.5 hover:font-semibold">
          ...
          <div class="rounded-md bg-gray-100 py-0.5 px-2 text-xs text-gray-700">pro</div>
        </div>
        <div class="flex items-center gap-2 transition-all hover:pl-0.5 hover:font-semibold">
