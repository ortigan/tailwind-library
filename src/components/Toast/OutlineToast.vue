<template>
  <div class="w-full">
    <span v-for="(item, index) in items" :key="index">
      <div
        :class="`bg-white flex justify-between items-center px-4 py-3 rounded-lg text-gray-500 w-1/3 ${item.borderColor} mb-2`"
      >
