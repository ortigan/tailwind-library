<template>
  <div
    class="flex flex-col lg:flex-row w-full justify-between lg:items-center px-6 py-5 rounded-lg shadow-lg bg-white dark:bg-gray-900"
  >
    <!-- logo -->
    ...
    <div class="">
        ...
        <ul class="flex flex-col lg:flex-row text-gray-700 dark:text-gray-400 font-medium gap-2 lg:gap-4 mt-2 lg:mt-0">
...
<div class="flex items-center relative">
            <input type="text" class="p-2 pl-10 placeholder:text-gray-400 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-300 sm:text-sm focus:ring-sky-500 focus:border-sky-500 " placeholder="Search...">
