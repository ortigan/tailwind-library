<template>
  <div class="w-full text-gray-500">
    <div class="">
        <ul class=" bg-white inline-flex -space-x-px font-medium">
            <li class="px-3 py-2 border hover:text-gray-700 hover:cursor-pointer hover:bg-gray-50 border-gray-200 rounded-l-lg">Previous</li>
            ...
            <li class="px-3 py-2 border hover:text-gray-700 hover:cursor-pointer hover:bg-gray-50 border-gray-200  rounded-r-lg">Next</li>
        </ul>
    </div>
  </div>
</template>
